...
export class UserController {
  ...
  async findAll({
    query,
  }: ElysiaContext<unknown, unknown, z.infer<typeof PaginationQuery>>) {
  ...
  async findOne({
    params,
    set,
  }: ElysiaContext<unknown, z.infer<typeof UserIdParam>>) {
  ...
  async update({
    ...
    z.infer<typeof UpdateUserDto>,
    z.infer<typeof UserIdParam>
  >) {
